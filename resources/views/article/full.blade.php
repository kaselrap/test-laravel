                    ...
                    <div class="card mb-12">
                        <div class="card-body">
                            @if(isset($article->video) && !empty($article->video))
                                {{--<iframe class="card-img-top" width="560" height="315" src="https://www.youtube.com/embed/VjHIAjUQRWY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>--}}
                                {{--<iframe class="card-img-top" src="{!! $article->video . "&output=embed" !!}" frameborder="0"></iframe>--}}
                                {!! Embed::make($article->video)->parseUrl()->setAttribute(['class'=>'card-img-top', 'autoplay' => 1])->getIframe() !!}
                            @else
